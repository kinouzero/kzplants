  ...
  <div class="card">
    <div class="card-body">
      ...
      <h1 class="d-flex text-center align-items-center">
        <i class="fas fa-sitemap fa-2xs me-2"></i>{{ __('app.preferences') }}
        <div class="ms-auto d-flex align-items-center">
          <a class="btn btn-outline-secondary" href="{{ route('preference.create') }}" title="{{ __('ui.create') }}" data-bs-toggle="tooltip"
